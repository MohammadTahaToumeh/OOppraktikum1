...
public class BahnhoefeControl {
	...
	void nehmeBahnhofAuf(){
    	try{ 
    		bahnhoefeModel.addBahnhof(new Bahnhof(bahnhoefeView.getTxtName().getText(), bahnhoefeView.getTxtOrt().getText(), Integer.parseInt(bahnhoefeView.getTxtAnzahlGleise().getText()), Integer.parseInt(bahnhoefeView.getTxtLetzteRenovierung().getText()), bahnhoefeView.getTxtZugarten().getText().split(";")));
